    ...
    <section className="py-24 font-poppins">
      <div className="container mx-auto px-4 text-center">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-12 max-w-6xl mx-auto">
          {/* Phone Mockup with enhanced visuals */}          <div className="md:w-1/2 flex justify-center">
          ...
          {/* App Details with enhanced card */}          <div className="md:w-1/2 text-left">
            <div className="bg-white p-8 rounded-2xl shadow-md border border-gray-100">
              ...
              </div>              {/* Download buttons with styling matching the image */}
              <div className="space-y-4">
                <a href="https://mediscan.kethanvr.me" target="_blank" rel="noopener noreferrer" className="block">
                  <button
                    type="button"
                    className="w-full flex items-center justify-center bg-gradient-to-r from-blue-500 to-blue-600 text-white px-6 py-3 rounded-lg font-semibold"
                  >
                    🌐 Visit Website
                  </button>
                </a>
